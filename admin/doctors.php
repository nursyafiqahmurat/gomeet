            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                        <a href="doctors.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Pegawai</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-schedule">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Jadual</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="doctors.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Papar semua Juruteknik &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">                        
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="doctors.php"><input type="button" value="Tutup" class="login-btn btn-primary-soft btn" ></a>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            ';
                ...
                $error_1=$_GET["error"];
                $errorlist= array(
                    '1'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Sudah mempunyai akaun untuk alamat emel ini</label>',
                    ...
                    '3'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Maklumat Bagi Kad Pengenalan Ini Sudah Ada</label>',
                    '4'=>"",
                    '0'=>'',
                    ...
                    <div id="popup1" class="overlay">
                        <div class="popup">
                            ...
                            <br><br><br><br>
                                ...
                                <div style="display: flex;justify-content: center;">                                
                                <a href="doctors.php" class="non-style-link"><button class="btn-primary btn" style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;Tutup&nbsp;&nbsp;</font></button></a>
                                </div>
                                <br><br>
                            </center>
                        </div>
