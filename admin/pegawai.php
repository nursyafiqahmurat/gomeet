                ...
                <tr >
                    ...
                    <td>                        
                        <form action="" method="post" class="header-search">
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Carian nama pegawai atau emel" list="pegawai">&nbsp;&nbsp;                            
                            <?php
                                echo '<datalist id="pegawai">';
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="pegawai.php"><button class="login-btn btn-primary-soft btn" style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Papar Semua Pegawai &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
