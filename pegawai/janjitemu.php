                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="submit" value="Pilih Sesi Ini" class="login-btn btn-primary btn" name="janjitemusubmit">
                                </td>            
                            </tr>
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                        ...
                        <br><br>
                            ...
                            <a class="close" href="janjitemu.php">&times;</a>
                            <div class="content">
                            '.substr($titleget,0,40).' telah dipilih<br><br>                            
                            </div>
                            <div style="display: flex;justify-content: center;">                        
                        ...
                        <center>
                            ...
                            <div class="content">                        
                                ...
                                <table width="80%" class="sub-table scrolldown add-staff-form-container" border="0">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <a href="janjitemu.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a> 
                                        </td>                
                                    </tr>
                                </table>
                            </div>
